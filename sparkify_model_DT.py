...
class sparkify_model:
    ...
    def train_model(self, train_data, valid_data):
        ...
        dt = DecisionTreeClassifier(featuresCol='features', labelCol=self.label, predictionCol='churn_pred')
        # Create the pipeline
...
if __name__ == '__main__':
    ...
    shutil.make_archive('model_cv_dt', 'zip', output_path)
